...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo ""
            echo "  # ParticleNet method with full unblinding"
            echo "  $0 --mode all --method ParticleNet --binning extended --unblind"
            echo ""
...
# Select mass points based on method. Test mode intentionally stays on the
# HybridNew subsets when configured; otherwise it falls back through
# load_masspoints.sh to baseline/particlenet.
...
echo "============================================================"
echo "SignalRegionStudyV3 HybridNew Batch Submission"
