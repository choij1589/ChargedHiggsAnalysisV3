...
sys.path.insert(0, f"{WORKDIR}/SignalRegionStudyV3/python")
...
def _compute_paths():
    ...
    TEMPLATE_DIR = (f"{WORKDIR}/SignalRegionStudyV3/templates/"
...
def load_subchannel_config(era, channel):
    ...
    tdir = f"{WORKDIR}/SignalRegionStudyV3/templates/{era}/{channel}/{args.masspoint}/{args.method}/{binning_suffix}"
...
def sample_path(era, channel, process):
    return f"{WORKDIR}/SignalRegionStudyV3/samples/{era}/{channel}/{args.masspoint}/{process}.root"
