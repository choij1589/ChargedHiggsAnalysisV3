...
def main():
    ...
    base_dir = os.path.join(workdir, "SignalRegionStudyV3", "templates", "2018", "SR1E2Mu")
    if not os.path.isdir(base_dir):
        base_dir = os.path.join("templates", "2018", "SR1E2Mu")
    if not os.path.isdir(base_dir):
        raise RuntimeError("Cannot find templates directory. Run from SignalRegionStudyV3.")
