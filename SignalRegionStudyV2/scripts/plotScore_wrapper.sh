...
ln -sf "$REPO_DIR/SignalRegionStudyV2/templates" "$LOCAL_WORKDIR/SignalRegionStudyV2/templates"

# Run plotParticleNetScore with local WORKDIR
export WORKDIR="$LOCAL_WORKDIR"
python3 "$REPO_DIR/SignalRegionStudyV2/python/plotParticleNetScore.py" \
