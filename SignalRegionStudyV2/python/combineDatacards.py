...
def combine_channels(era, masspoint, method, binning, workdir):
    ...
    for channel in CHANNELS:
        card_path = f"{workdir}/SignalRegionStudyV2/templates/{era}/{channel}/{masspoint}/{method}/{binning}/datacard.txt"
        shapes_path = f"{workdir}/SignalRegionStudyV2/templates/{era}/{channel}/{masspoint}/{method}/{binning}/shapes.root"
...
def combine_eras(eras, channel, masspoint, method, binning, output_era, workdir):
    ...
    shapes_files = {}
    for era in eras:
        base_dir = Path(f"{workdir}/SignalRegionStudyV2/templates/{era}/{channel}/{masspoint}/{method}/{binning}")
