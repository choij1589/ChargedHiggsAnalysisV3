...
def load_multiclass_predictions_from_root(signal, channel, fold, pilot=False, separate_bjets=False):
    ...
    try:
        with uproot.open(root_file) as file:
            ...
            return y_true_train, y_scores_train, weights_train, y_true_test, y_scores_test, weights_test, class_names
...
def main():
    ...
    try:
        ...
        (y_true_train, y_scores_train, weights_train,
         y_true_test, y_scores_test, weights_test, class_names) = load_multiclass_predictions_from_root(
            args.signal, args.channel, args.fold, args.pilot, args.separate_bjets)
