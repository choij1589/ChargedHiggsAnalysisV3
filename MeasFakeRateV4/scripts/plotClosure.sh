...
SYSTs=("Central" "TT" "bjet" "cjet" "ljet")
...
plot_closure() {
    ...
    local histkey=$3
    local syst=$4
    plotClosure.py --era $era --channel $channel --histkey $histkey --syst $syst
}

export -f plot_closure

parallel plot_closure ::: $ERA ::: Run1E2Mu ::: ${HISTKEYs_El[@]} ::: ${SYSTs[@]}
parallel plot_closure ::: $ERA ::: Run3Mu ::: ${HISTKEYs_Mu[@]} ::: ${SYSTs[@]}
