...
json_output_path = f"{WORKDIR}/MeasFakeRateV2/plots/{args.era}/{args.channel}/closure_yield.json"
...
output_path = f"{WORKDIR}/MeasFakeRateV2/plots/{args.era}/{args.channel}/closure_{args.histkey.replace('/', '_').lower()}.png"
