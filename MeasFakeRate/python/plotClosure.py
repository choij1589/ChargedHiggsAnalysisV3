...
for era in era_list:
    file_path = f"{WORKDIR}/SKNanoOutput/BackUps/ClosFakeRate_MeasFakeRate/{args.channel}/{era}/Skim_TriLep_TTLL_powheg.root"
...
json_output_path = f"{WORKDIR}/MeasFakeRate/plots/{args.era}/{args.channel}/closure_yield.json"
...
output_path = f"{WORKDIR}/MeasFakeRate/plots/{args.era}/{args.channel}/closure_{args.histkey.replace('/', '_').lower()}.png"
