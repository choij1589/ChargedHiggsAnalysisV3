...
cp results/${ERA}/ROOT/electron/fakerate_qcd.root ../SKNanoAnalyzer/data/Run3_v13_Run2_v9/${ERA}/EGM/root/fakerate_qcd_TopHNT.root
...
cp results/${ERA}/ROOT/muon/fakerate_qcd.root ../SKNanoAnalyzer/data/Run3_v13_Run2_v9/${ERA}/MUO/root/fakerate_qcd_TopHNT.root
