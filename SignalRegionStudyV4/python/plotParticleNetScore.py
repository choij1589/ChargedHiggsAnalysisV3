...
histkeys_path = f"{WORKDIR}/SignalRegionStudyV4/configs/histkeys.json"
...
if is_combined_era or is_combined_channel:
    ...
    syst_config_path = f"{WORKDIR}/SignalRegionStudyV4/configs/systematics.{args.era}.json"
...
def load_syst_categories_for(era, channel):
    ...
    syst_config_path = f"{WORKDIR}/SignalRegionStudyV4/configs/systematics.{era}.json"
