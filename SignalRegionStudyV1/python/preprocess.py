#!/usr/bin/env python3
"""
Preprocess signal and background samples for SignalRegionStudyV1.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Preprocess samples for SignalRegionStudyV1")
    parser.add_argument("--era", required=True, type=str, help="era (e.g., 2018)")
...
class SamplePreprocessor:
    ...
    def __init__(self, era, channel, masspoint, convSF=1.0):
        ...
        self.is_trained_sample = (80 < self.mA < 100)
